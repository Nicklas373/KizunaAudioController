...
class AudioNode {
    ...
    var audio_client_tl_init =
        "/sdcard/Android/data/com.hana.kizunaaudiocontroller/files/Download/audio_client_tl_init.txt"
    var audio_client_bl_init =
        "/sdcard/Android/data/com.hana.kizunaaudiocontroller/files/Download/audio_client_bl_init.txt"
    var audio_client_init =
        "/sdcard/Android/data/com.hana.kizunaaudiocontroller/files/Download/audio_client_init.txt"
    var kao_audio_init =
        "/sdcard/Android/data/com.hana.kizunaaudiocontroller/files/Download/kao_audio_init.txt"
    var kao_aclient =
        "/sdcard/Android/data/com.hana.kizunaaudiocontroller/files/Download/kao_aclient.txt"
    var kao_aclient_top_limit =
        "/sdcard/Android/data/com.hana.kizunaaudiocontroller/files/Download/kao_aclient_tl.txt"
    var kao_aclient_bottom_limit =
